                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="LoanController" method="post" onsubmit="return validateForm();">
                            ...
                            <div class="mb-3">
                                <label for="bookId" class="form-label">ISBN del Libro:</label>
                                <input type="number" class="form-control" id="bookId" name="bookId" required>
                            </div>

                            <div class="mb-3">
                                <label for="borrower" class="form-label">Titulo del Libro:</label>
                                <input type="text" class="form-control" id="borrower" name="borrower" required>
                            </div>

                            <div class="mb-3">
                                <label for="loanDate" class="form-label">Autor del Libro:</label>
                                <input type="text" class="form-control" id="loanDate" name="loanDate" required>
                            </div>

                            <div class="mb-3">
                                <label for="returnDate" class="form-label">Tipo de libro:</label>
                                <input type="text" class="form-control" id="returnDate" name="returnDate" required>
                            </div>
                            
                            <div class="mb-3">
                                <label for="returnDate" class="form-label">Fecha de publicacion:</label>
