...
<head>
    ...
    <title>Registro - Sistema de Gestión de Libros</title>
    <style>
        ...
        * {
        ...
        .registro-form .form-group select {
            width: 100%;
            padding: 12px 15px;
        ...
        .registro-form .form-group select:focus {
            outline: none;
            background: rgba(255, 255, 255, 0.2);
            border-color: rgba(255, 255, 255, 0.4);
        }
        
        .registro-form .form-group input::placeholder {
            color: rgba(255, 255, 255, 0.6);
        }
        
        .registro-form .form-group select option {
...
<body>
    ...
    <div class="registro-container">
        ...
        <c:if test="${not empty mensaje}">
            <div class="alert alert-${tipo != null ? tipo : 'info'}">
                ${mensaje}
            </div>
        </c:if>
